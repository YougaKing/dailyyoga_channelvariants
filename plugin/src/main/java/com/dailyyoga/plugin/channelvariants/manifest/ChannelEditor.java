package com.dailyyoga.plugin.channelvariants.manifest;


import com.dailyyoga.plugin.channelvariants.manifest.decode.BTagNode;
import com.dailyyoga.plugin.channelvariants.manifest.decode.AXMLDoc;
import com.dailyyoga.plugin.channelvariants.manifest.decode.BXMLNode;
import com.dailyyoga.plugin.channelvariants.manifest.decode.StringBlock;
import com.dailyyoga.plugin.channelvariants.manifest.utils.TypedValue;
...
public class ChannelEditor {
    ...
    public ChannelEditor(AXMLDoc doc, String channelName) {
        this.doc = doc;
